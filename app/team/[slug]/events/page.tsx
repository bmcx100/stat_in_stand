...
import MatricivesContent from "../playdowns/matricives-content"
  ...
  if (isOwhaMode) {
    ...
    return (
      <div className="dashboard-page">
        ...
        <details className="events-card" open>
          <summary className="events-card-title">Provincials</summary>
        {config.teamNames && (
              ...
              <div className="overflow-x-auto" ref={tableScrollRef}>
                <table className="standings-table">
                  <thead><tr>
                    ...
                    <th className="playdown-expand-col" onClick={() => toggleExpand()} />
                  </tr></thead>
                  <tbody>
                    {(() => {
                      ...
                      return playdownStandings.map((row, i) => (
                        ...
                        >
                          ...
                          <td className={`playdown-expand-col ${i === midIdx ? (isEven ? "playdown-expand-icon-bottom" : "playdown-expand-icon-center") : ""}`} onClick={(e) => { e.stopPropagation(); toggleExpand() }}>
