...
import { ChevronUp, ChevronDown, Shuffle, Lock, Unlock } from "lucide-react"
...
export default function MatricivesContent() {
  ...
  if (!playdown || !teamNames || teamNames.length === 0) {
    return <p className="dashboard-record-label">No playdowns configured yet.</p>
  }
